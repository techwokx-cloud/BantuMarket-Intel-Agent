...
Powered by Anthropic Claude, Streamlit, and Bright Data
"""
...
# ============================================================================
# HEADER WITH TECH STACK & SPONSORS (Fixed, Professional)
# ============================================================================
...
<div class="sponsor-section">
    ...
    <p style="margin: 0;">
        <span class="tech-badge">Claude Opus 4</span>
        <span class="tech-badge">Agentic AI</span>
        <span class="tech-badge">Tool Use</span>
        <span class="tech-badge">Streamlit Cloud</span>
        <span class="tech-badge">Residential Proxies</span>
        <span class="tech-badge">AfCFTA Framework</span>
    </p>
</div>
""", unsafe_allow_html=True)
...
<div style='text-align: center; padding: 20px 0;'>
    <p style='color: var(--text-secondary); font-size: 0.85em; margin: 0 0 12px 0;'>
        <strong>BantuMarket Intel Agent</strong> | v1.0 | AfCFTA Trade Intelligence
    </p>
    <p style='color: var(--text-secondary); font-size: 0.8em; margin: 0 0 8px 0;'>
        Built with <strong>Anthropic Claude</strong> | Deployed on <strong>Streamlit Cloud</strong> | Infrastructure by <strong>Bright Data</strong>
    </p>
    <p style='color: var(--text-secondary); font-size: 0.75em; margin: 0;'>
        Unlocking AfCFTA trade with AI-powered market intelligence
    </p>
</div>
""", unsafe_allow_html=True)
